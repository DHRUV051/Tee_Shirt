...
const Container6 = () => {
  return (
    <main className='small:hidden px-[150px]  small:px-[30px]  medium:px-[30px]  flex small:flex-col medium:flex-col space-x-[50px] small:space-x-0 medium:space-x-0 medium:space-y-[50px] small:space-y-[50px]'>
      <section className='w-full  mt-[20px] bg-[url("/assets/Home(DHRUV)/select1.svg")] bg-cover   px-[20px] py-[40px] bg-no-repeat  h-fit'>
      ...
      <section className='w-full h-[390px] mt-[9px] bg-[url("/assets/Home(DHRUV)/select2.svg")] bg-cover bg-no-repeat  px-[20px] py-[40px] medium:w-[100%]  rounded-[12px] '>
